...
namespace binapi
{
  ...
  namespace rest
  {
    ...
    //  - https://api.binance.com/api/v3/exchangeInfo?symbols=%5B%22BTCUSDT%22,%22BNBBTC%22%5D
    ...
    struct exchange_info_t
    {
      ...
      struct symbol_t
      {
        ...
        struct filter_t
        {
          //PRICE_FILTER : the price rules for a symbol.
          ...
          boost::variant<
              filter_price_t, filter_percent_price_t, filter_lot_t, filter_market_lot_t, filter_min_notional_t, filter_iceberg_parts_t, filter_max_num_orders_t, filter_max_num_algo_orders_t, filter_max_position_t>
              filter;
              ...
              new_order_info_ack_t, new_order_info_result_t, new_order_info_full_t, new_test_order_info_t>
    {
      // ctor inheritance
      using boost::variant<
          new_order_info_ack_t, new_order_info_result_t, new_order_info_full_t, new_test_order_info_t>::variant;
